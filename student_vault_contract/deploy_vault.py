...
# ============ IMPORTANT: PASTE YOUR PRIVATE KEY HERE ============
# Get this from Pera Wallet:
# Open Pera → Tap VHTC...2MXM account → Tap 3 dots → View Private Key → Copy
