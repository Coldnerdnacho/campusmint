...
try:
    # Try different method names (SDK version compatibility)
    try:
        account_info = client.account_info(address)  # Newer SDK
    except AttributeError:
        account_info = client.account_information(address)  # Older SDK
    ...
    print(f"  ❌ Error: {e}")
    print(f"\n  Troubleshooting:")
    print(f"  1. Make sure your wallet has ALGO")
    print(f"  2. Fund at: https://bank.testnet.algorand.network/")
    print(f"  3. Your address: {address}")
    exit(1)
...
print("\nNext step: python deploy_vault_working.py")
print()